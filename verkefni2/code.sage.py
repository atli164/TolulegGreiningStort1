...
_sage_const_3 = Integer(3); _sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_2p7 = RealNumber('2.7'); _sage_const_4 = Integer(4); _sage_const_100 = Integer(100); _sage_const_2p0 = RealNumber('2.0'); _sage_const_4p7 = RealNumber('4.7'); _sage_const_1p5 = RealNumber('1.5'); _sage_const_14p1 = RealNumber('14.1'); _sage_const_8p1 = RealNumber('8.1'); _sage_const_0p3 = RealNumber('0.3'); _sage_const_3p9 = RealNumber('3.9'); _sage_const_0p5 = RealNumber('0.5'); _sage_const_10 = Integer(10); _sage_const_7p8 = RealNumber('7.8'); _sage_const_0p9 = RealNumber('0.9'); _sage_const_1p8 = RealNumber('1.8')# Constants given in exercise
def px(t):
...
def frameplot(x, y, dx, dy, tol, n, c, name, xb, yb):
    ...
    for i in range(n):
        pl = parametric_plot((x(t), y(t)), (t, _sage_const_0 , _sage_const_1 ),figsize=[_sage_const_3 ,_sage_const_4 ],
                             ...
                             xmax=xb[_sage_const_1 ], ymin=yb[_sage_const_0 ],ymax=yb[_sage_const_1 ], fig_tight=True)
        pos = bissearch(dx, dy, tol, i / (n - _sage_const_1 ), c)
        pl += point((x(pos), y(pos)))
        pl.save(name + '_frame' + str(i//_sage_const_10 )+str(i%_sage_const_10 ) + '.png')

frameplot(px,py,dpx,dpy,_sage_const_10  ** (-_sage_const_4 ), _sage_const_100 , c1, 'curve1', (_sage_const_0 ,_sage_const_1p5 ), (_sage_const_0 ,_sage_const_2p0 ))
